...
.PARAMETER Clean
Removes the image hod-nilesh-kedare and kills all containers based on that image.
...
Build a Docker image named hod-nilesh-kedare
#>
...
$imageName="hod-nilesh-kedare"
$projectName="hodnileshkedare"
$publicPort=3000
